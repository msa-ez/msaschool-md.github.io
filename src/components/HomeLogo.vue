<template>
    ...
    >
        <image
            ...
            x="0"
            y="0"
            style = "object-fit: fill; width:300px; height:80px; padding:-10px 0 -10px 0 !important;"
            xlink:href="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAfwAAACKCAYAAABPXvh7AA
    ...
    <!-- <div>
        <v-img src="/msa_school.png" contain v-bind:style="styleObject"></v-img>
    </div> -->
